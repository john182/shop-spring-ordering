package com.shop.ordering.presentation.shoppincart;
...
import com.shop.ordering.infrastructure.persistence.entity.ShoppingCartPersistenceEntityTestDataBuilder;
import com.shop.ordering.infrastructure.persistence.shoppingcart.ShoppingCartPersistenceEntity;
...
public class ShoppingCartControllerIT {
    ...
    public void shouldCreateShoppingCart() {
        String json = ResourceUtils.readContent("json/create-shopping-cart.json");
    ...
    public void shouldAddProductToShoppingCart() {
        String json = ResourceUtils.readContent("json/add-product-to-shopping-cart.json");
